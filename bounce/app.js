require = (function e(t, n, r) {
  ...
  "4PCcoK": [function(require, module, exports) {
    var App, BaseView, Bounce, BoxView, Events, ExportView, PreferencesView, PrefixFree, ShortenView, URLHandler, template, _, __bind = function(fn, me) {
        return function() {
    ...
    "bounce": "c1he0F",
    "prefixfree": "NGk3jQ",
    "scripts/events": "jL3HsY",
    "scripts/setup": "xdNEL6",
    "scripts/urlhandler": "dSBOTS",
    "scripts/views/base": "/l3mMY",
    "scripts/views/box": "FpVIhp",
    "scripts/views/export": "+SnGsf",
    "scripts/views/preferences": "D05IS4",
    "scripts/views/shorten": "wpiY4R",
    "templates/app": "G1z9mA",
    "underscore": 101
  }],
  "scripts/app": [function(require, module, exports) {
  ...
  "t42j+F": [function(require, module, exports) {
    ...
    "../easing/bounce": "YYToEi",
    "../easing/hardbounce": "PioQnB",
    "../easing/hardsway": "QP+fRn",
    "../easing/sway": "EwwsAM",
    "../math/matrix4d": "HpNQed"
  }],
  "scripts/lib/bounce/components/index": [function(require, module, exports) {
    module.exports = require('t42j+F');
  }, {}],
  "NE9Tvp": [function(require, module, exports) {
    var Component, Matrix4D, Rotate, Vector2D, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "1BqU+7": [function(require, module, exports) {
    var Component, Matrix4D, Scale, Vector2D, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "xBMRcD": [function(require, module, exports) {
    var Component, Matrix4D, Skew, Vector2D, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "scripts/lib/bounce/components/skew": [function(require, module, exports) {
    module.exports = require('xBMRcD');
  }, {}],
  "Yi8bvd": [function(require, module, exports) {
    var Component, Matrix4D, Translate, Vector2D, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "scripts/lib/bounce/components/translate": [function(require, module, exports) {
  ...
  "YYToEi": [function(require, module, exports) {
    var BounceEasing, Easing, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "scripts/lib/bounce/easing/hardbounce": [function(require, module, exports) {
    module.exports = require('PioQnB');
  }, {}],
  "PioQnB": [function(require, module, exports) {
    var BounceEasing, HardBounceEasing, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "QP+fRn": [function(require, module, exports) {
    var HardSwayEasing, SwayEasing, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "scripts/lib/bounce/easing/hardsway": [function(require, module, exports) {
  ...
  "EwwsAM": [function(require, module, exports) {
    var BounceEasing, SwayEasing, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "c1he0F": [function(require, module, exports) {
    ...
    Bounce = (function() {
      ...
      Bounce.prototype.translate = function(options) {
        var demo = this.addComponent(new ComponentClasses["translate"](options));
        console.log(demo);
        return demo;
      };
    ...
    "./components/rotate": "NE9Tvp",
    "./components/scale": "1BqU+7",
    "./components/skew": "xBMRcD",
    "./components/translate": "Yi8bvd",
    "./math/matrix4d": "HpNQed"
  }],
  ...
  "BFH2vT": [function(require, module, exports) {
    var $, ToggleButton, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      };
  ...
  "xdNEL6": [function(require, module, exports) {
    ...
    "jquery": "MtfruI",
    "nouislider": "CKvjVX",
    "scripts/lib/jquery.togglebutton": "BFH2vT"
  }],
  "scripts/setup": [function(require, module, exports) {
  ...
  "/l3mMY": [function(require, module, exports) {
    var Backbone, BaseView, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "scripts/views/base": [function(require, module, exports) {
    module.exports = require('/l3mMY');
  }, {}],
  "FpVIhp": [function(require, module, exports) {
    var BaseView, Bounce, BoxView, _, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      },
  ...
  "scripts/views/box": [function(require, module, exports) {
  ...
  "iwEgR8": [function(require, module, exports) {
    var BaseView, Component, Events, template, _, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      },
    ...
    "scripts/events": "jL3HsY",
    "scripts/views/base": "/l3mMY",
    "templates/component": "bTuG/Y",
    "underscore": 101
  }],
  "scripts/views/export": [function(require, module, exports) {
    module.exports = require('+SnGsf');
  }, {}],
  "+SnGsf": [function(require, module, exports) {
    var $, ExportView, ModalView, URLHandler, template, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      },
    ...
    "jquery": "MtfruI",
    "scripts/urlhandler": "dSBOTS",
    "scripts/views/modal": "UWCCbc",
    "templates/export": "W1BMiS"
  }],
  "QMi9Pf": [function(require, module, exports) {
    var BaseView, InputView, _, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      },
  ...
  "scripts/views/inputs/index": [function(require, module, exports) {
  ...
  "O4fej5": [function(require, module, exports) {
    var InputView, RotateInputView, template, _, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
    ...
    "./index": "QMi9Pf",
    "templates/inputs/rotate": "9Zwbqa",
    "underscore": 101
  }],
  "gN18R1": [function(require, module, exports) {
    var ScaleInputView, VectorInputView, template, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
    ...
    "./vector": "Azn1fi",
    "templates/inputs/scale": "VloDe9"
  }],
  "scripts/views/inputs/scale": [function(require, module, exports) {
    module.exports = require('gN18R1');
  }, {}],
  "NVh/Q+": [function(require, module, exports) {
    var SkewInputView, VectorInputView, template, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "abfBP3": [function(require, module, exports) {
    var TranslateInputView, VectorInputView, template, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
    ...
    "./vector": "Azn1fi",
    "templates/inputs/translate": "ottZS9"
  }],
  ...
  "Azn1fi": [function(require, module, exports) {
    var InputView, VectorInputView, _, __hasProp = {}.hasOwnProperty,
      __extends = function(child, parent) {
        for (var key in parent) {
          if (__hasProp.call(parent, key)) child[key] = parent[key];
        }
  ...
  "UWCCbc": [function(require, module, exports) {
    var $, BaseView, ModalView, _, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      },
  ...
  "D05IS4": [function(require, module, exports) {
    var BaseView, Bounce, ComponentView, Events, PreferencesView, template, _, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      },
    ...
    "scripts/events": "jL3HsY",
    "scripts/views/base": "/l3mMY",
    "scripts/views/component": "iwEgR8",
    "templates/preferences": "hTEbct",
    "underscore": 101
  }],
  "scripts/views/preferences": [function(require, module, exports) {
  ...
  "wpiY4R": [function(require, module, exports) {
    var ModalView, ShortenView, template, __bind = function(fn, me) {
        return function() {
          return fn.apply(me, arguments);
        };
      },
  ...
  "templates/export": [function(require, module, exports) {
  ...
  "templates/inputs/scale": [function(require, module, exports) {
  ...
  "qu4LtV": [function(require, module, exports) {
    // hbsfy compiled Handlebars template
    var Handlebars = require('hbsfy/runtime');
    module.exports = Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
      this.compilerInfo = [4, '>= 1.0.0'];
  ...
  "templates/inputs/skew": [function(require, module, exports) {
  ...
  "hTEbct": [function(require, module, exports) {
    // hbsfy compiled Handlebars template
    var Handlebars = require('hbsfy/runtime');
    module.exports = Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
      this.compilerInfo = [4, '>= 1.0.0'];
  ...
  "templates/preferences": [function(require, module, exports) {
  ...
  "Zvq4H4": [function(require, module, exports) {
/*!
...
$.Link (part of noUiSlider) - WTFPL */
    (function(b) {
      ...
      function g(a, e) {
        ...
        return new g.prototype.p(a.target ||
        function() {}, a.method, a.format || {}, e)
      }
      ...
      g.prototype.p = function(a, e, d, g) {
        this.g = d;
        this.update = !g;
        if ("string" === typeof a && 0 === a.indexOf("-tooltip-")) this.K(a, e);
      ...
      g.prototype.write = function(a, b, d, g) {
        if (!this.update || !1 !== g) if (this.u = a, this.F = a = this.format(a), "function" === typeof this.method) this.method.call(this.target[0] || d[0], a, b, d);
...
$.fn.noUiSlider - WTFPL - refreshless.com/nouislider/ */
    (function(b) {
      ...
      function T(d, c, h) {
        ...
        function l(a) {
          var b, c = [s.val()];
          for (b = 0; b < a.length; b++) s.trigger(a[b], c)
        }
        function q(d, p, f) {
          var g = d[0] !== m[0][0] ? 1 : 0,
            H = v[0] + c.margin,
        ...
        function t(a, b, d, f) {
          ...
          b.on(a, function(a) {
            ...
            if (p || e) e || void 0 !== window.pageXOffset || (window.pageXOffset = document.documentElement.scrollLeft, window.pageYOffset = document.documentElement.scrollTop), D = a.clientX + window.pageXOffset, g = a.clientY + window.pageYOffset;
            l.C = [D, g];
            l.cursor = p;
            a = l;
            a.l = a.C[c.k];
        ...
        (function(a) {
          var b;
          if (!a.fixed) for (b = 0; b < m.length; b++) t(x.start, m[b].children(), C, {
            b: [m[b]]
          });
          a.s && t(x.start, r, A, {
            b: m
          ...
          a.v && (b = r.find("." + k[7]).addClass(k[10]), a.fixed && (b = b.add(r.children().not(b).children())), t(x.start, b, C, {
            b: m
          }))
        })(c.n);
        d.vSet = function() {
          ...
          for (r = 0; r < a; r++) h = e || w[r % 2][0], h = h.A(t[r % 2]), !1 !== h && (h = u(c, h), c.dir && (h = 100 - h), !0 !== q(m[r % 2], h, !0) && b(w[r % 2]).each(function(a) {
            ...
            this.write(F, m[r % 2].children(), s, f)
          }));
          !0 === d && l(["set"]);
          return this
        };
  ...
  93: [function(require, module, exports) {
    "use strict"; /*globals Handlebars: true */
